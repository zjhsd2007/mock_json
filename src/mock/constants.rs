...
pub const PHONE_PREFIX: [&'static str; 6] = ["133", "149", "153", "159", "135", "139"];
pub const FIRST_NAME: [&'static str; 66] = [
    "James",
    "John",
    "Robert",
    "Michael",
...
pub const LAST_NAME: [&'static str; 32] = [
    "Smith",
    "Johnson",
    "Williams",
    "Brown",
